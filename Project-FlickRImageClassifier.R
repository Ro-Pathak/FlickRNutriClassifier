...
#save_model_hdf5(model, "AI Project/Project-Group6-FlickRImageClassifier.h5")
...
# Load test image
test_image <- image_load("AI Project/pasta11.jpg",
                         target_size = target_size)

# Display the image
img <- readJPEG("AI Project/pasta11.jpg")
